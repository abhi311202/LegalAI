...
const UserDashboard1 = () => {
  ...
  return (
    <div className="flex max-h-[630px]  bg-gray-100 mt-[65px] dark:bg-[#222] dark:text-white">
      <div className="w-64 bg-black text-white py-4 px-1 flex flex-col justify-between max-h-[630px]">
