  ...
  return (
    <div className="flex min-h-screen max-h-max bg-gray-100">
      ...
      <div className="w-64 bg-black text-white p-6 flex flex-col justify-between rounded-r-2xl">
        ...
        <div>
          {/* <h1 className="text-center text-sm"> &copy; Legal AI 2024 </h1> */}
          <h1 className="text-center text-sm">&copy; Legal AI {new Date().getFullYear()}</h1>
        </div>
      </div>

      {/* Main Content Area */}
      <div className="flex-1 p-6">
        <h1 className="text-5xl font-bold text-gray-800 mb-10 text-center bg-black text-white p-5 rounded-2xl">
